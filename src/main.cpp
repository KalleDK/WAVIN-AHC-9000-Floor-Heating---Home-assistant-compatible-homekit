...
String   MQTT_USER    = "";                    // mqtt user. Use "" for no username / no input in captive portal
String   MQTT_PASS    = "";                    // mqtt password. Use "" for no password / no input in captive portal
...
void setup()
{
  ...
  Serial.println("\n\n\r  *******************************************");  
  Serial.println      ("            WAWIN AHC-9000 GATEWAY           ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("            MQTT / HOME ASSISTANT            ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("          https://github.com/jascdk          ");
  Serial.println      ("  *******************************************\n\n");
 
  Serial.println("\n\n\r  *******************************************");  
  Serial.println      ("  CREDITS TO THESE COOL DEVELOPERS AT GITHUB ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("        https://github.com/heinekmadsen      ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("          https://github.com/dkjonas         ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("           https://github.com/paller         ");
  Serial.println      ("  *******************************************\n\n");
 
  Serial.println("\n\n\r  *******************************************");
  Serial.println      ("        TO SETUP YOUR SYSTEM - GO TO SSID    ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("           WAVIN AHC-9000 MQTT GATEWAY       ");
  Serial.println      ("                    *******                  ");
  Serial.println      ("           FILL OUT THE CAPTIVE PORTAL       ");
  Serial.println      ("  *******************************************\n\n");  
  ...
  // Custom CSS styling for captive portal - change HEX colors as you wish:)
  wifiManager.setCustomHeadElement("<style>body{background: #BBCEB2;}button{transition: 0.3s;opacity: 0.8;cursor: pointer;border:0;border-radius:1rem;background-color:#3E7ACF;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%;}button:hover {opacity: 1}button[type=\"submit\"]{margin-top: 15px;margin-bottom: 10px;font-weight: bold;text-transform: capitalize;}input{height: 30px;font-family:verdana;margin-top: 5px;background-color: rgb(253, 253, 253);border: 0px;-webkit-box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75);-moz-box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75);box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75);}div{color: #3E7ACF;}div a{text-decoration: none;color: #14a762;}div[style*=\"text-align:left;\"]{color: black;}, div[class*=\"c\"]{border: 0px;}a[href*=\"wifi\"]{border: 2px solid #3E7ACF;text-decoration: none;color: #3E7ACF;padding: 10px 30px 10px 30px;font-family: verdana;font-weight: bolder;transition: 0.3s;border-radius: 5rem;}a[href*=\"wifi\"]:hover{background: #3E7ACF;color: white;}</style>");
  ...
  if (drd.detectDoubleReset())
    {
      ...
      wifiManager.startConfigPortal("WAVIN AHC-9000 MQTT GATEWAY");
    }
  else
  {
    ...
    if (!wifiManager.autoConnect("WAVIN AHC-9000 MQTT GATEWAY")) {
  ...
  Serial.println("\n\n\r  *******************************************");  
  Serial.println      ("    CONGRATULATIONS YOU ARE NOW CONNECTED :D ");
  Serial.println      ("  *******************************************\n\n");
